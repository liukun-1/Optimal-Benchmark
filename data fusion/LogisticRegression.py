...
parser = argparse.ArgumentParser(description="LogisticRegression 微生物属分类建模")
...
parser.add_argument("--output", default="LogisticRegression", help="输出文件夹")
...
print(f"✅ LogisticRegression 完成，结果已保存到 {OUTPUT_DIR}")
