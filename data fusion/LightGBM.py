...
# ======== 命令行参数 ========
parser = argparse.ArgumentParser(description="LightGBM微生物属分类建模")
...
parser.add_argument("--output", default="LightGBM_results", help="输出文件夹")
...
print(f"✅ LightGBM 完成，结果已保存到 {OUTPUT_DIR}")
