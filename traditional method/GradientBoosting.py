...
parser = argparse.ArgumentParser(description="GradientBoosting微生物属分类建模")
parser.add_argument("--train", required=True)
parser.add_argument("--test", required=True)
parser.add_argument("--output", default="con_results_GradientBoosting")
...
for i in range(repeat):
    seed = i
    clf = GradientBoostingClassifier(n_estimators=500, learning_rate=0.05, random_state=seed)
