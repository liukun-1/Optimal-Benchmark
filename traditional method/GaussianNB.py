...
parser = argparse.ArgumentParser(description="GaussianNB微生物属分类建模")
parser.add_argument("--train", required=True)
parser.add_argument("--test", required=True)
parser.add_argument("--output", default="con_results_GaussianNB")
...
for i in range(repeat):
    ...
    # GaussianNB没有feature_importances_，用方差近似重要性
