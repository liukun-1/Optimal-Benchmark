...
parser = argparse.ArgumentParser(description="KNN微生物属分类建模")
parser.add_argument("--train", required=True)
parser.add_argument("--test", required=True)
parser.add_argument("--output", default="con_results_KNN")
...
for i in range(repeat):
    ...
    if hasattr(clf, "predict_proba"):
        ...
        y_prob = clf.predict(X_test)  # 对于没有predict_proba的，使用预测值近似
