...
parser.add_argument("--output", default="con_results_XGBoost")
...
for i in range(repeat):
    seed = i
    clf = XGBClassifier(n_estimators=500, learning_rate=0.05, use_label_encoder=False, eval_metric='logloss', random_state=seed)
