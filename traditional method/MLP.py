...
parser = argparse.ArgumentParser(description="MLP微生物属分类建模")
parser.add_argument("--train", required=True)
parser.add_argument("--test", required=True)
parser.add_argument("--output", default="con_results_MLP")
...
for i in range(repeat):
    seed = i
    clf = MLPClassifier(hidden_layer_sizes=(100,), max_iter=5000, random_state=seed)
